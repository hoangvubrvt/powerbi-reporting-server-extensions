...
- Configuration `<appSettings>` inner the element `<configuration>` as below. (https://corptb.sharepoint.com/sites/identityaccessmanagement/sitepages/qg071.aspx?web=1#qa-environment)
